  ...
  return (
    <div className="App">
      ...
      <section class="hero-image">
        ...
        {/* Hero */}
        <div class="box px-5 flex flex-row items-center justify-center text-center">
          {/* Text */}
          <div class="flex flex-col  md:w-1/2 text gap-y-10">
            <div class="flex flex-col gap-y-5">
              <h1 class="text-2xl md:text-4xl text-[#533FBA] font-bold">Want a Graphic Design that caught your eyes like this one?</h1>
